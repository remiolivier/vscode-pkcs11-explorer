...
class EncryptModel {
    ...
    async performEncrypt(key, keyType) {
    ...
    async performEncryptOnce(key, keyType) {
        const mechanism = await this.getEncryptDecryptMechanism(keyType);
        if (mechanism == undefined) {
            return;
        }
...
//# sourceMappingURL=encryptModel.js.map